...
public class KayıtSorusu {
     ...
     Bunun için;
 1- Bir user(Kullanıcı) class create fields: name , registerDate(kayıtZamanı) (LocalDateTime cinsinden)
 2- Kayıt(Kayıt) isminde bir class oluşturmak ve register()(kayıtAl()) isminde bir metod
 ...
 Kayıt yeniKayıt = yeni Kayıt();
     ArrayList<Kullanıcı> kisi = yeniKayıt.kayıtAl();
      yeniKayıt.sanslıKullanıcı(kullaınıcı);
     }
