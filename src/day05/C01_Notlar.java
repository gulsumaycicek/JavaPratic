 ...
 */
        ...
        String arr[] = listIsimler.toArray(new String[0]);//arr adında String tipinde bir array tanımladık.
        // isimlerden(List) toArray ile yeni String tipi obj değerleri atadık
